            ...
            <div class="w-full flex justify-center my-8">
                <div class="w-96 border-2 border-gray-300 bg-gray-100 p-6 shadow-md">
                    <div class="text-center mb-4">
                        <h2 class="text-xl font-bold font-serif">Kullanıcı Girişi</h2>
                        <div class="w-full h-px bg-gray-400 my-2"></div>
                    </div>

                    <form class="space-y-4" method="POST" action="loginn.php">
                        ...
                        <div class="flex flex-col">
                            <label class="mb-1 text-sm font-bold" for="password">Şifre:</label>
                            <input
                            name="password"
                                type="password"
                                id="password"
                        ...
                        <div class="flex justify-between items-center mt-4">
                            ...
                            <a href="#" class="text-blue-700 underline text-sm hover:text-blue-900">Şifremi Unuttum</a>
                        </div>
                    </form>

                    <div class="mt-4 text-center">
                        <p class="text-xs text-gray-600">Hesabınız yok mu? <a href="#" class="text-blue-700 underline hover:text-blue-900">Kayıt Ol</a></p>
                    </div>
                </div>
            </div>
